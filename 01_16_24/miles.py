"""Miles per gallon demo program by Angela Venable"""
...
#starting_mileage = int(input("Enter the starting mileage: "))
print(f"The mile's per gallon is {miles_per_gallon:.2f}")
print('In the resources module on a page titled, "Viewing Lecture Recordings"')